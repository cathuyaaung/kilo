...
.factory('Auth', function($firebaseAuth, FBURL, $window) {
  ...
  return{
      ...
      createUser : function createUser(user){
        return $firebaseAuth(ref).$createUser({
            userName : user.userName,
            email: user.email,
            password: user.pass
        });
      },
      loginWithPassword : function loginWithPassword(user){
      ...
      facebookLogin : function facebookLogin(){
        return $firebaseAuth(ref).$authWithOAuthPopup("facebook");
      }      
  }; 
})
.factory('Users', function($firebaseArray,$firebaseObject, FBURL, $window) {
  ...
  return{
      ...
      createUserProfile : function createUser(user){
        return users.$add({'name' : user.userName, 'uid' : user.uid});
      }      
  }; 
})
